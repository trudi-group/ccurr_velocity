...
\newcommand{\emphtext}[1]{\textcolor{jwiblue}{{#1}}}
\newcommand{\inputTikz}[1]{%
	\ifdefined\varInputTikz\input{./tikz/#1}\fi%
}

\newcommand{\inputTable}[2]{%
	\scalebox{#1}{\input{./tables/#2}}%
}%
...
\newcommand{\Pph}{{P_\pherd}}
\newcommand{\Tp}{{T_\perd}}
\newcommand{\Tph}{{T_\pherd}}
...
\newcommand{\coinsSmall}{{\texttt{\tiny coins}}}
\newcommand{\cow}{{\mathtt{cow}}}
\newcommand{\cowSmall}{{\texttt{\tiny cow}}}
\newcommand{\sheep}{{\mathtt{sheep}}}
\newcommand{\sheepSmall}{{\texttt{\tiny sheep}}}
...
\newcommand{\blockspace}{1em}
\newcommand{\blockspaceOld}{\blockspace}
\newcommand{\blockcoloralert}{jwiorange}

%\setbeamercolor{block body}{parent=normal text,bg=jwilightgreen!40!white}
\setbeamercolor{block body alerted}{parent=normal text,use=block title alerted,bg=\blockcoloralert}
%\setbeamercolor{block body example}{parent=normal text,use=block title alerted,bg=hugreen!50!bg}


\newenvironment{alertblockc}[3][Y]{%
	\renewcommand{\blockspaceOld}{\blockspace}%
	%spacing after block
	\if #1Y%
	\else%
		\renewcommand{\blockspace}{0em}%
	\fi%
	%box coloring
	\setbeamercolor{block body alerted}{parent=normal text, use=block title alerted, bg=#3}
	\begin{alertblock}{#2}%
		\centering%
%		\begin{center}%
}{%
%		\end{center}%
	...
	\vspace{\blockspace}%
	\setbeamercolor{block body alerted}{parent=normal text, use=block title alerted, bg=\blockcoloralert}
	\renewcommand{\blockspace}{\blockspaceOld}%
}%

\renewcommand\footnotemark{}
\renewcommand\footnoterule{}

\newcommand{\footnotetextNN}[1]{{%
		\let\thempfn\relax% Remove footnote number printing mechanism
		\footnotetext[0]{\emph{\scriptsize#1}}% Print footnote text
}}
