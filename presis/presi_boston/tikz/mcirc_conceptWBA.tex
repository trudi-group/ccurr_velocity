...
%	\coordinate (cen)       at ($(0.0,0.0)   + ( 0.0       , 0.0         )$) (cen)    [\debugPoint];%
	...
	\coordinate (BChange)   at ($(BCC)       + ( 0.0       , \picH*0.2500)$) (BChange)[\debugPoint];%	
	...
	%Vertical Lines============================================================%
	\draw[vis on =<2->,  - , line width = \lineW, dashed]                (LCD)  -- (LCU);
	\draw[vis on =<2-4>, - , line width = \lineW, dashed]                (LBD)  -- (LBU);
	\draw[vis on =<5-5>, - , line width = \lineW, dashed, jwigreige!40] (LBD)  -- (LBU);
	\draw[vis on =<5->,  - , line width = \lineW, dashed]                (LAD)  -- (LAU);
	%Horizontal Lines==========================================================%
	\draw[vis on =<1- >, ->, line width = \lineW, solid] (TL)    -- (TR);
	\draw[vis on =<2-4>,<->, line width = \lineW]        (LBDA)  -- node[midway, below]{$p$} (LCDA);
	\draw[vis on =<5->, <->, line width = \lineW]        (LAD)   -- node[midway, below]{$p$} (LCD);
%	\draw[vis on =<2-9>,  - , gray  , line width = \lineW] (LAD)  -- node[midway, below, black, black!40!white]{$p$'} (LCD);
	...
	\node[vis on =<1->, nodeInnerBA] (NBAUAR) at (BAUAR)                      {\color{black!50}\fontset{}$\mathit{Out_3}$};
	...
	%node B Up, Tx_C-----------------------------------------------------------%
	\node[vis on =<1-4>, nodeOuter]   (NBBU)   at (BBUCC)                      {};
	\node[vis on =<5-5>, nodeOuterH]  (NBBU)   at (BBUCC)                      {};
	\node[vis on =<6-> , nodeOuter]   (NBBU)   at (BBUCC)                      {};
	...
	\node[vis on =<1->, nodeInnerBD] (NBBUBL) at (BBUBL)                      {\fontset{}$\mathsf{Inp_1}$};
	\node[vis on =<1->, nodeInnerBB] (NBBUCR) at ($(BBUCR)+(0.0,-\BOH*0.05)$) {\fontset{}$\mathsf{Out_1}$};
	\node[vis on =<1->, nodeInnerBB] (NBBUAR) at ($(BBUAR)+(0.0, \BOH*0.05)$) {\color{black!50}\fontset{}$\mathit{Out_2}$};
	
	%node B Down, Tx_D-----------------------------------------------------------%
	\node[vis on =<1-5>, nodeOuter]   (NBBD)   at (BBDCC)                      {};
	\node[vis on =<6-6>, nodeOuterH]  (NBBD)   at (BBDCC)                      {};
	\node[vis on =<7-> , nodeOuter]   (NBBD)   at (BBDCC)                      {};
	...
	%node C Down, Tx_E-----------------------------------------------------------%
	\node[vis on =<1-2>, nodeOuter]   (NBCD)   at (BCDCC)                      {};
	\node[vis on =<3-3>, nodeOuterH]  (NBCD)   at (BCDCC)                      {};
	\node[vis on =<4->,  nodeOuter]   (NBCD)   at (BCDCC)                      {};
	...
	\node[vis on =<1->, nodeInnerBA] (NBCDAR) at (BCDAR)                      {\color{black!50}\fontset{}$\mathit{Out_3}$};
	
	%node D Up, Tx_F-----------------------------------------------------------%
	\node[vis on =<1-3>, nodeOuter]   (NBDU)   at (BDUCC)                      {};
	\node[vis on =<4-4>, nodeOuterH]   (NBDU)   at (BDUCC)                      {};
	\node[vis on =<5->, nodeOuter]   (NBDU)   at (BDUCC)                      {};
	...
	\node[vis on =<1->, nodeInnerBB] (NBDUAR) at ($(BDUAR)+(0.0, \BOH*0.05)$) {\color{black!50}\fontset{}$\mathit{Out_2}$};
	...
	\draw[lineIO , ->, vis on=<1-4>] (NBBUCR.east) .. controls ($(NBBUCR.east) + ( 0.75, 0.00)$) and ($(NBCDCL.west) + (-0.75, 0.00)$) .. (NBCDCL.west); %TxC --> TxE
	\draw[lineION, ->, vis on=<5-> ] (NBBUCR.east) .. controls ($(NBBUCR.east) + ( 0.75, 0.00)$) and ($(NBCDCL.west) + (-0.75, 0.00)$) .. (NBCDCL.west); %TxC --> TxE
	...
	\draw[lineIO , ->, vis on=<1-3>] (NBCDBR.east) .. controls ($(NBCDBR.east) + ( 0.75, 0.00)$) and ($(NBDUAL.west) + (-0.75, 0.00)$) .. (NBDUAL.west); %TxE --> TxF
	\draw[lineION, ->, vis on=<4-> ] (NBCDBR.east) .. controls ($(NBCDBR.east) + ( 0.75, 0.00)$) and ($(NBDUAL.west) + (-0.75, 0.00)$) .. (NBDUAL.west); %TxE --> TxF
	...
	\pic[vis on=<1-> ,] () at ($(NBAUAR.east) + (-\BOH*0.075, 0.0        )$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
	...
	%TxC-----------------------------------------------------------------------%
%	\pic[vis on=<1-4>,] () at ($(NBBUBL.east) + (-\BOH*0.125,-\BOH*0.0375)$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
%	\pic[vis on=<5-> ,] () at ($(NBBUBL.east) + (-\BOH*0.125,-\BOH*0.0375)$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoinY}{black!80!white}{black!90!white}};
	
	\pic[vis on=<1-4>,] () at ($(NBBUBL.east) + (-\BOH*0.075, \BOH*0.0375)$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
	\pic[vis on=<5-> ,] () at ($(NBBUBL.east) + (-\BOH*0.075, \BOH*0.0375)$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoinY}{black!80!white}{black!90!white}};
	
	\pic[vis on=<1-4>,] () at ($(NBBUBL.east) + (-\BOH*0.115, \BOH*0.1100)$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
	\pic[vis on=<5-> ,] () at ($(NBBUBL.east) + (-\BOH*0.115, \BOH*0.1100)$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoinY}{black!80!white}{black!90!white}};
	
	\pic[vis on=<1-> ,] () at ($(NBBUCR.east) + (-\BOH*0.075, 0.0        )$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
	\pic[vis on=<1-> ,] () at ($(NBBUAR.east) + (-\BOH*0.075, 0.0        )$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
	...
	%TxE-----------------------------------------------------------------------%
	\pic[vis on=<1-2>,] () at ($(NBCDCL.east) + (-\BOH*0.075, 0.0        )$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
	\pic[vis on=<3-4>,] () at ($(NBCDCL.east) + (-\BOH*0.075, 0.0        )$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoinY}{black!80!white}{black!90!white}};
	\pic[vis on=<5-> ,] () at ($(NBCDCL.east) + (-\BOH*0.075, 0.0        )$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoinN}{black!80!white}{black!90!white}};
	
	\pic[vis on=<1-2>,] () at ($(NBCDBL.east) + (-\BOH*0.115,-\BOH*0.0375)$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
	\pic[vis on=<3-> ,] () at ($(NBCDBL.east) + (-\BOH*0.115,-\BOH*0.0375)$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoinY}{black!80!white}{black!90!white}};
	
	\pic[vis on=<1-2>,] () at ($(NBCDBL.east) + (-\BOH*0.075, \BOH*0.0375)$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
	\pic[vis on=<3-> ,] () at ($(NBCDBL.east) + (-\BOH*0.075, \BOH*0.0375)$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoinY}{black!80!white}{black!90!white}};
	
	\pic[vis on=<1-> ,] () at ($(NBCDAR.east) + (-\BOH*0.075, 0.0        )$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
	...
	%TxF-----------------------------------------------------------------------%
	\pic[vis on=<1-3>,] () at ($(NBDUAL.east) + (-\BOH*0.075, 0.0        )$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
	\pic[vis on=<4-> ,] () at ($(NBDUAL.east) + (-\BOH*0.075, 0.0        )$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoinN}{black!80!white}{black!90!white}};
	
	\pic[vis on=<1-3>,] () at ($(NBDUCL.east) + (-\BOH*0.075, 0.0        )$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
	\pic[vis on=<4-> ,] () at ($(NBDUCL.east) + (-\BOH*0.075, 0.0        )$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoinY}{black!80!white}{black!90!white}};
	
	\pic[vis on=<1-> ,] () at ($(NBDUAR.east) + (-\BOH*0.075, 0.0        )$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
	\pic[vis on=<1-> ,] () at ($(NBDUCR.east) + (-\BOH*0.075, 0.0        )$) {coin={0.7pt}{0.05}{\BOH*0.12}{\colorCoin} {black!80!white}{black!90!white}};
	
	%Counter Node==============================================================%
	\pic[vis on=<3->  ] ()        at ($(BCount) + ( \BOH*0.225/2, 0.05)$) {coin={1.0pt}{0.07}{\BOH*0.225}{\colorCoinY}{black!90!white}{black!100!white}};
	\node[vis on=<3-3>] (NBCount) at ($(BCount) + (-\BOH*0.225/2, 0.00)$) {\fontset{}\huge\textbf{3}};
	\node[vis on=<4-4>] (NBCount) at ($(BCount) + (-\BOH*0.225/2, 0.00)$) {\fontset{}\huge\textbf{4}};
	\node[vis on=<5->]  (NBCount) at ($(BCount) + (-\BOH*0.225/2, 0.00)$) {\fontset{}\huge\textbf{6}};
	
	%Change outs?=============================================================%
	\node[vis on=<7-7>,rotate=20] (NBChange) at ($(BChange) + ( 0.00, 0.00)$) {\fontset{}\huge\textbf{change outputs?}};
\end{tikzpicture}
}%